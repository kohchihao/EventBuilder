...
const ServiceSection = ({
  ...
  return (
    <SectionWrapper>
      <Container>
        <Box {...secTitleWrapper}>
          <Text {...secText} content="OUR PLEDGE TO YOU" />
          <Heading
            {...secHeading}
            content="Choose the package that fits your criterias"
          />
          <Text
            {...secDes}
            content="We have hundreds of packages customized for each event type and there will be one that fits your corporate needs."
          />
        </Box>
